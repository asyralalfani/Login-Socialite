...
<div class="wrapper">
    ...
    {{ csrf_field() }}         
      <h4 class="form-signin-heading text-center" style="margin-top:10px;margin-bottom:20px; font-family: Montserrat, sans-serif;">Register With Email</h4>
   <br><br>
        ...
        <input id="password" type="password" class="form-control "style="color:black" placeholder="Password" style="color:black" name="password" required>
        ...
        <div class="form-group" >
            <input id="password-confirm" placeholder="Password Confirm"style="color:black" type="password" class="form-control" name="password_confirmation" required>
        </div>
        <div class="form-group" >
